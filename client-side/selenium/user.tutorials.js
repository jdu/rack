...
.then(function (el) { return b.clickElement(el); })
.then(function () { return b.elementById("twine-tutorials-btn"); })
.then(function (el) { return b.clickElement(el); })
.then(function () { return b.elementByLinkText("Basic Indicator Report"); })
.then(function (el) { return b.clickElement(el); })
.then(function () { return b.elementById("nextButton"); })
.then(function (el) { return b.clickElement(el); })
.then(function () { return b.elementById("nextButton"); })
.then(function (el) { return b.clickElement(el); })
.then(function () { return b.elementById("nextButton"); })
...
.then(function () { return b.elementById("nextButton"); })
.then(function (el) { return b.clickElement(el); })
.then(function () { return b.elementById("quitButton"); })
.then(function (el) { return b.clickElement(el); })
.then(function () { return b.elementByXPath("//div[@id='user_controls']/div/a[2]"); })
.then(function (el) { return b.clickElement(el); })
